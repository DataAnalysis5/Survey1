...
function generateSurveyColumns(questions, surveyColor) {
  ...
  const questionsPerColumn = Math.ceil(questions.length / 2) // Distribute evenly between 2 columns
  const columns = []
  let currentColumn = []
  ...
  questions.forEach((question, index) => {
    ...
    // Start a new column when we reach the calculated questions per column
  ...
  // Ensure we always have at least 2 columns for separator to work
